...

{
  ...
  home.file = {
    ...
    #----------------#
        ...
        bindsym $mod+Shift+d exec kitty --class="danmufloat" --hold sh -c "cd /home/khaneliman/Codelearning/go/src/bilibili_live_tui/  && export TERM=xterm-256color && go run main.go -c config.toml" 
