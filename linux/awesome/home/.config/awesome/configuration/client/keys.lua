...
local client_keys = awful.util.table.join(
	...
	awful.key(
		...
		'Up',
		function(c)
			c.screen = c.screen:get_next_in_direction('up')
		end,
		{description = 'Move client to screen above', group = 'client'}
	),
	awful.key(
		{modkey, altkey},
		'Down',
		function(c)
			c.screen = c.screen:get_next_in_direction('down')
		end,
		{description = 'Move client to screen below', group = 'client'}
	),
	awful.key(
		{modkey, altkey},
		'Left',
		function(c)
			c.screen = c.screen:get_next_in_direction('left')
		end,
		{description = 'Move client to screen to left', group = 'client'}
	),
	awful.key(
		{modkey, altkey},
		'Right',
		function(c)
			c.screen = c.screen:get_next_in_direction('right')
		end,
		{description = 'Move client to screen to right', group = 'client'}
	)
)
