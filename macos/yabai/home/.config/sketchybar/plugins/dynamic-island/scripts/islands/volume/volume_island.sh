#!/usr/bin/env sh
source "$HOME/.config/sketchybar/plugins/dynamic-island/scripts/configs/volume.sh"
source "$HOME/.config/sketchybar/plugins/dynamic-island/scripts/configs/icons.sh"
