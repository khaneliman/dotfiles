#!/usr/bin/env sh
source "$HOME/.config/sketchybar/plugins/dynamic-island/scripts/configs/music.sh"
ARTWORK_LOCATION="$HOME/.config/sketchybar/plugins/dynamic-island/scripts/islands/music/artwork.jpg"
...
if [[ $MUSIC_SOURCE == "Music" ]]; then
	osascript "$HOME/.config/sketchybar/plugins/dynamic-island/scripts/islands/music/get_artwork.scpt"
